...
const QuestionsTabFrontend = () => (
  <div>
    ...
    <ul>
      ...
      <li>The *apos;C&apos; in CSS stands for Cascading.  How is priority determined in assigning styles (a few examples)?  How can you use this system to your advantage?</li>
