...
const QuestionsTabFrontend = () => (
  <Fragment>
    ...
    <ul>
      ...
      <li>
        What UI, Security, Performance, SEO, Maintainability or Technology considerations do you
        make while building a web application or site?
      </li>
    ...
    <ul>
      ...
      <li>
        What&apos;s the difference between full standards mode, almost standards mode and quirks
        mode?
      </li>
      ...
      <li>
        Describe the difference between a<code>cookie</code>,<code>sessionStorage</code> and
    ...
    <ul>
      ...
      <li>
        What are the different ways to visually hide content (and make it available only for screen
        readers)?
      </li>
      ...
      <li>
        Explain your understanding of the box model and how you would tell the browser in CSS to
        render your layout in different box models.
      </li>
      <li>
        What does
      ...
      <li>
        What*apos;s the difference between a relative, fixed, absolute and statically positioned
        element?
      </li>
      <li>
        The *apos;C&apos; in CSS stands for Cascading. How is priority determined in assigning
        styles (a few examples)? How can you use this system to your advantage?
      </li>
      <li>
        What existing CSS frameworks have you used locally, or in production? How would you
        change/improve them?
      </li>
    ...
    <ul>
      ...
      <li>
        What&apos;s the difference between feature detection, feature inference, and using the UA
        string?
      </li>
      ...
      <li>
        What is
        <code>&apos;use strict&apos;;</code>? what are the advantages and disadvantages to using it?
      </li>
      <li>
      ...
      <li>
        Why is it, in general, a good idea to leave the global scope of a website as-is and never
        touch it?
      </li>
      <li>
        Why would you use something like the
        <code>load</code> event? Does this event have disadvantages? Do you know any alternatives,
      ...
      <li>
        What are some of the advantages/disadvantages of writing JavaScript code in a language that
    ...
    <ul>
      ...
      <li>
        Do your best to describe the process from the time you type in a website&apos;s URL to it
        finishing loading on your screen.
      </li>
